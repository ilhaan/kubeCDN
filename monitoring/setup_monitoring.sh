...
# East
kubectl create -f prometheus-storageclass.yaml --kubeconfig=../terraform/east-kubeconfig
...
# West
kubectl create -f prometheus-storageclass.yaml --kubeconfig=../terraform/west-kubeconfig
